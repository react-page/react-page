...
const working = [
    {
        ...
        expected: new Editable('1', '', [
            new Section('default', null, '<div data-section="default">Content</div>')
        ])
    },
    {
    ...
    },
    {
        ...
        expected: new Editable('1', '', [
            new Section('default', null, '<div data-section="default"><span>foobar</span></div>')
        ])
    },
    {
        html: '<div class="editable" data-id="1">foobar</div>',
        expected: new Editable('1', '', [
            new Section('default', null, '<div data-section="default">foobar</div>')
        ])
    }
];
        ...
        describe('DOMParser', function () {
            ...
            it('should properly parse data', function () {
                ...
                u.each(working, function (v) {
                    ...
                    expect(dp.parse(element)).toEqual(v.expected);
                });
            });
