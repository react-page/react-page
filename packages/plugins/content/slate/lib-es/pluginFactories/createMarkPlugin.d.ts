...
declare const _default: (markDef: MarkPluginDefinition) => {
    <CT extends Record<string, unknown> = Record<string, unknown>>(customize?: (t: import("../types/slatePluginDefinitions").SlateComponentPluginDefinition<Record<string, unknown>>) => import("../types/slatePluginDefinitions").SlateComponentPluginDefinition<CT>): {
...
//# sourceMappingURL=createMarkPlugin.d.ts.map