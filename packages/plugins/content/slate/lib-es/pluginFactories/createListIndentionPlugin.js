    ...
    return [
        {
            ...
            customAdd: function (editor) { return __awaiter(void 0, void 0, void 0, function () {
                var increaseListIndention;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, import('./utils/listUtils')];
                        case 1:
                            increaseListIndention = (_a.sent()).increaseListIndention;
            ...
            customRemove: function (editor) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            isDisabled: function (editor) { return __awaiter(void 0, void 0, void 0, function () {
                var getPreviousListItem, previous;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, import('./utils/listUtils')];
                        case 1:
                            getPreviousListItem = (_a.sent()).getPreviousListItem;
                            previous = getPreviousListItem(editor, def.listItemType);
        ...
        },
        {
            ...
            isDisabled: function (editor) { return __awaiter(void 0, void 0, void 0, function () {
                var getActiveListType;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, import('./utils/listUtils')];
                        case 1:
                            getActiveListType = (_a.sent()).getActiveListType;
                            return [2 /*return*/, !getActiveListType(editor)];
                    }
                });
            }); },
        },
