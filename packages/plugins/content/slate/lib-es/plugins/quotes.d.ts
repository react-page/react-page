declare const _default: {
    blockQuote: {
        <CT extends Record<string, unknown> = import("../pluginFactories/createSimpleHtmlBlockPlugin").DefaultBlockDataType>(customize?: (t: import("../types/slatePluginDefinitions").SlateComponentPluginDefinition<import("../pluginFactories/createSimpleHtmlBlockPlugin").DefaultBlockDataType>) => import("../types/slatePluginDefinitions").SlateComponentPluginDefinition<CT>): {
