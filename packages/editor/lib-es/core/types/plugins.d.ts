...
export type CellPluginMissingProps = Omit<CellPluginComponentProps, 'pluginConfig'> & {
    pluginId: string;
};
export type CellPluginRenderer<DataT extends DataTType = DataTAny> = React.ComponentType<CellPluginComponentProps<DataT> & {
    children?: React.ReactNode;
}>;
export type CellPluginCustomControlsComonent<DataT extends DataTType> = React.ComponentType<CellPluginComponentProps<DataT>>;
export type CellPluginAutoformControlsContent<DataT extends DataTType> = React.ComponentType<{
    columnCount?: number;
...
export type ControlsDefList<DataT extends DataTType = DataTAny> = Array<SubControlsDef<Partial<DataT>>>;
/**
 * All available type of controls
 */
export type ControlsDef<DataT extends DataTType = DataTAny> = AutoformControlsDef<DataT> | CustomControlsDef<DataT> | ControlsDefList<DataT>;
export type PluginHandler = (e: Event, node?: Cell | null) => void | Promise<void>;
export type CellPlugin<DataT extends DataTType = DataTAny, DataSerializedT = DataT> = {
    /**
     ...
     */
    Provider?: React.ComponentType<PropsWithChildren<CellPluginComponentProps<DataT>>>;
    /**
     ...
     */
    cellSpacing?: number | CellSpacing | ((data: DataT) => number | CellSpacing | null);
    /**
     ...
     */
    cellPlugins?: CellPluginList | ((cellPlugins: CellPluginList, data: DataT) => CellPluginList);
    /**
