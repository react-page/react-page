...
type StringProperty<FullData> = {
     ...
     */
    pattern?: string;
} & CommonPropertyProps<FullData> & WithEnum<string>;
...
} & CommonPropertyProps<FullData> & WithEnum<number>;
...
type ObjectProperty<FieldData extends Record<string, unknown>, FullData> = BaseObjectProps<FieldData, FullData> & CommonPropertyProps<FullData>;
...
export type JsonSchemaProperty<Field, Data> = Field extends (infer U)[] ? ArrayProperty<U, Data> : Field extends Record<string, unknown> ? ObjectProperty<Field, Data> : Field extends string ? StringProperty<Data> : Field extends number ? NumberProperty<Data> : Field extends boolean ? BooleanType<Data> : never;
