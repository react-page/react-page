...
const state = {
  editables: [{
    present: {
      ...
      cells: [{
        ...
        rows: [{
          ...
          cells: [{
            ...
            props: { importFromHtml: '<h1>European? British? These ‘Brexit’ Voters Identify as English</h1>' },
            id: 'c38fa00e-6b34-4c6d-af3f-2c1374edad11',
            plugin: { name: 'ory/content/draft-js', version: '0.0.1' },
            hover: null,
            size: 12,
            bounds: { left: 0, right: 0 },
            resizable: false,
          ...
          cells: [{
            ...
            plugin: { name: 'ory/content/image', version: '0.0.1' },
            hover: null,
            size: 12,
            bounds: { left: 0, right: 0 },
            resizable: false,
          ...
          cells: [{
            ...
            props: { src: 'https://static01.nyt.com/images/2016/06/16/world/16England-web1/16England-web1-master768.jpg' },
          ...
          cells: [{
            ...
            rows: [{
              ...
              cells: [{
                ...
                inline: 'left',
                props: { src: 'https://static01.nyt.com/images/2016/06/16/world/16England-web2/16England-web2-master675.jpg' },
          ...
          cells: [{
            ...
            rows: [{
              ...
              cells: [{
                ...
                props: { importFromHtml: 'Castle Point district of Essex, full of people who have made it out of London’s tough East End to a kind of English paradise with lots of single-family homes, lawns, beaches, seaside amusement parks and fish-and-chip shops.' },
                ...
                props: { importFromHtml: 'The people here are fiercely English, fiercely Conservative and fiercely pro-Brexit, as the possible exit is being called, and many feel that their sovereignty and identity are being diluted by a failing European Union and an “uncontrolled” influx of foreigners.' },
      ...
      config: { whitelist: ['ory/content/missing', 'ory/content/image', 'ory/content/spacer', 'ory/content/draft-js', 'ory/layout/spoiler'] }
    }
  }, {
    present: {
      id: '2',
      cells: [{
        ...
        rows: [{
          ...
          cells: [{
            levels: { left: 2, right: 2, above: 1, below: 1 },
            props: { importFromHtml: 'Duis autem vel eum<script type="text/javascript">alert("XSS");</script> iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.' },
